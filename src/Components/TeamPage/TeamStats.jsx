...
export const TeamStats = () => {
    return (
        <section className="max-w-7xl mx-auto px-6 md:px-12 xl:px-6 py-12">
            <div className="space-y-6 justify-between text-gray-600 md:flex flex-row-reverse md:gap-6 md:space-y-0 lg:gap-12 lg:items-center">
                ...
                <article className="md:7/12 lg:w-1/2">
                    ...
                    <section className="divide-y space-y-4 divide-gray-100 dark:divide-gray-800">
